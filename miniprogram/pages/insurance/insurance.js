...
var loadInsuranceList = function () {
    var _ref = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var db, items, ret;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 3;
                        return db.collection("insurance").where({
    ...
    return function loadInsuranceList() {
        return _ref.apply(this, arguments);
    };
}();

var saveSampleInsurance = function () {
    var _ref2 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
        var db, ret;
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        db = wx.cloud.database();
                        _context3.next = 3;
                        return db.collection("insurance").add({
                            data: {
                    ...
                    case 3:
                        ret = _context3.sent;
                        return _context3.abrupt("return", ret._id);
    ...
    return function saveSampleInsurance() {
        return _ref2.apply(this, arguments);
    };
}();

Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = __webpack_require__(/*! ../../utils/util */ "./src/utils/util.js");
var app = getApp();
Page({
    data: {
        items: [{ "insuranceID": "11111", plate: "粤A DE077", dateCreated: "2019-07-03" }, { "insuranceID": "2222", plate: "粤A DE078", dateCreated: "2019-07-03" }]
    },
